...
from utils import get_config, get_data_loader_folder, pytorch03_to_pytorch04, load_inception, load_vgg19
...
parser.add_argument('--config', type=str, default='configs/tir2rgb_folder', help='Path to the config file.')
